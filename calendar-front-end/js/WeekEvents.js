$(document).ready(function (ev) {
    ...
    $("#week-events-button").click(function (ev) {
        $("main")
            .html(
                '<div class="container">' +
                ...
                '</div>' +
                '<div class="form-group">' +
                '<button id = "submit-week-button" type="button" class="btn btn-secondary" name="submit" value="submit">Submit</button>' +
                '</div>' +
                '</form>' +
                '</div>' +
                '</div>' +
        ...
        $("main").off().on("click", "#submit-week-button", function (ev) {
